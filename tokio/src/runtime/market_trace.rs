...
pub(crate) const SPAN_DPDK_RAW_TAIL_FINISH: u16 = 113;
...
pub(crate) const SPAN_DPDK_RAW_TAIL_PACKET_PARSE: u16 = 140;
pub(crate) const SPAN_DPDK_RAW_TAIL_TCP_COMMIT: u16 = 141;
pub(crate) const SPAN_DPDK_RAW_TAIL_LOCATE: u16 = 142;
pub(crate) const SPAN_DPDK_RAW_TAIL_PARSER: u16 = 143;
pub(crate) const SPAN_DPDK_RAW_TAIL_WAKE: u16 = 144;
pub(crate) const SPAN_DPDK_RAW_TAIL_EGRESS_QUEUE: u16 = 145;
pub(crate) const SPAN_DPDK_INFRA_ERROR_REPORT: u16 = 146;
pub(crate) const SPAN_DPDK_RX_BURST: u16 = 147;
pub(crate) const SPAN_DPDK_RX_CLASSIFY: u16 = 148;
